...
test.describe('Landing page', () => {
  test('shows all six task cards', async ({ page }) => {
    await page.goto('/');
    await expect(page.locator('.task-card')).toHaveCount(6);
    await expect(page.locator('.task-card:visible')).toHaveCount(6);
...
test.describe('Ready for Reproduction page', () => {
  test('renders the table structure and is reachable from the landing page', async ({ page }) => {
    await page.goto('/');
