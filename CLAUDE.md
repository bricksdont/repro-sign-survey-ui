...
Playwright tests cover (34 tests total):
...
- **Check detail**: core UI elements including both radio groups, back link → `check-index.html`, clearing a flag also clears its reason (#63), filtered-row click constrains ◀ ▶ to that subset / unfiltered click and direct navigation use the full collection (#75)
